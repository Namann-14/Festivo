    ...
    <footer className="bg-black/50 backdrop-blur-md border-t border-purple-500/20 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Festivo</h3>
            <p className="text-gray-400">
              The ultimate launchpad for the next generation of event tokens.
            </p>
          </div>
          <div>
            <h4 className="text-lg font-semibold mb-4">Quick Links</h4>
            <ul className="space-y-2 text-gray-400">
              <li><a href="/launch" className="hover:text-purple-400 transition">Launch Event</a></li>
